...
#
    ...
    $cmd .= " $g_xslts/rdfsort.xsl > $g_rdf/$g_rdfmark"."sisbyinv.rdf ";
...
#
    ...
    $cmd .= " $g_xslts/rdfsort.xsl > $g_rdf/$g_rdfmark"."sisbyce.rdf ";
...
#
    ...
    $cmd .= " $g_xslts/rdfsort.xsl > $g_rdf/$g_rdfmark"."sisbyfo.rdf ";
...
#
    ...
    $cmd .= " $g_xslts/rdfsort.xsl > $g_rdf/$g_rdfmark"."sisbygeo.rdf ";
...
#
    ...
    $cmd .= " $g_xslts/rdfsort.xsl > $g_rdf/$g_rdfmark"."sisbypa.rdf ";
...
#
    ...
    $cmd .= " $g_xslts/rdfsort.xsl > $g_rdf/$g_rdfmark"."sisbyca.rdf ";
...
#
    ...
    $cmd .= " $g_xslts/rdfsort.xsl > $g_rdf/$g_rdfmark"."sisbyua.rdf ";
