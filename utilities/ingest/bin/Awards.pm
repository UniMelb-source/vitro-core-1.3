...
if($Phases{'AWOR'}>0 || $g_all){
    ...
    $cmd .= " -o $g_rdf/$g_rdfmark"."awardOrganizations.rdf ";
...
if($Phases{'AWPR'}>0 || $g_all){
    ...
    $cmd = "";
    $cmd .= "java $g_saxonCmdSequence ";
    $cmd .= " -o $g_rdf/$g_rdfmark"."awardRecipients.rdf $g_aw/cawardRecipients.xml ";
...
if($Phases{'AWR'}>0 || $g_all){
    ...
    $cmd = "";
    $cmd .= "java $g_saxonCmdSequence -o $g_rdf/$g_rdfmark"."awards.rdf ";
