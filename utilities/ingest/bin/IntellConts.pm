...
#
    ...
    $cmd .= " $g_xslts/rdfsort.xsl > $g_rdf/$g_rdfmark"."sicjabya.rdf ";
...
#
    ...
    my $cmd = "";
    $cmd .= "java $g_javaopts $g_saxonCmdSequence ";
    $cmd .= " -o $g_rdf/$g_rdfmark"."cj.rdf $g_ic/cjds.xml ";
...
# prior GX, IC, CIA, -> CIP <-
    ...
    $cmd .= " $g_xslts/rdfsort.xsl > $g_rdf/$g_rdfmark"."sicbya.rdf ";
